                            ...
                            {showTemplateMail ? (
                                ...
                                <>
                                    ...
                                    <p className=" mx-auto text-white leading-relaxed text-base lg:text-lg ">
                                        RASPÁ EL LOGO <span className="text-yellowMain">Y DESCUBRÍ TU PREMIO</span> PODÉS GANAR HASTA $4.000 PARA VISITAR <br />
                                        BINGO OASIS PILAR
                                    </p> */}
                                        <img src={img} className="w-[30rem] lg:w-[26rem] xl:w-[24rem] 2xl:w-[32rem] mx-auto  animate-spin-once" alt="Titulo Alterno" />
                                        <p className="lg:w-2/3 mx-auto my-4 text-white leading-relaxed text-base sm:text-xl lg:text-lg xl:text-xl 2xl:text-xl ">
