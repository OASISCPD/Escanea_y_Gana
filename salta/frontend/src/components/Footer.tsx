...
export function Footer({ whatsapp, instagram, facebook }: PropsLinks) {
    ...
    return (
        <div className="w-full textGothamBook lg:mt-[10rem] xl:mt-[4rem] 2xl:mt-[2rem] font-semibold relative">
            <div className="custom-gradient  flex flex-col lg:flex-row lg:justify-between lg: justify-center lg:px-[5rem] items-center py-2 lg:pt-8">
                <img onClick={() => openLink('https://www.enrejasalta.com.ar/')} src={logoLoteria} className="w-[14rem] sm:w-[16rem] lg:w-[12rem] p-2 " alt="Logo Loteria" />
