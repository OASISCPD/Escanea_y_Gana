...
export function TemplateMailMobile() {
    ...
    //constante de referencia de template
    ...
    return (
        <div className="pt-12 sm:mx-[2rem] textGothamMedium">
            ...
            <div className="mt-16 flex justify-center">
                <img src={logo} className="w-[8rem] sm:w-[12rem] animate-spin-once-logo" alt="logo empresarial" />
            </div>
