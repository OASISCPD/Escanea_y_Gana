...
export function HomeMobile() {
    ...
    return (
        <div >
                        ...
                        {showTemplateMail ? (
                            ...
                            <>
                                <div className="flex flex-col text-center w-full my-[4rem] font-bold">
                                    <img src={img} className="w-[30rem] mx-auto sm:w-[40rem] animate-spin-once" alt="Titulo Alterno" />
                                    <p className="lg:w-2/3 mx-auto my-2 text-white leading-relaxed text-base ">
            ...
            {/* CASO QUE QUIERAN VALIDAR OTRAS CAMPANAS ANTES */}
            {/*  {modal && (
