                ...
                >
                    <div className="relative textGothamMedium">
                        ...
                        <div className="relative z-20 mx-[2rem] text-start py-16 sm:py-20 text-white ">
                            ...
                            <h1 className='text-xl sm:text-2xl my-4'>ESCANEÁ Y GANÁ
                            </h1>
                            <ol className='mx-[1rem] sm:mx-[2rem] text-base sm:text-xl'>
                                <li className='my-2'>
                                    1. La presente promoción en adelante “Escaneá y Ganá”, es organizada por NEWGAMING SRL o NUEVO CASINO ALBERDI - , CUIT 33-70826151-9, (en adelante, “ORGANIZADOR”), organiza el presente sorteo (conforme se define más adelante), el cual solo tendrá vigencia en la Ciudad de Salta, Provincia de Salta, República Argentina, sujeto a las siguientes bases y condiciones (“LAS BASES”).
                                </li>
                                <li className='my-2'>
                                ...
                                <li className='my-2'>
                                    4. La vigencia de la promoción será desde el 07 de Octubre de 2024 a las 10:00 hs hasta el 31 de Octubre de 2024 a las 23:59 hs.
                                ...
                                <li className='my-2'>
                                    6. Mecánica de la promoción. El usuario accederá a suerte.newgaming.com.ar donde encontrará el juego de “escaneá y ganá” con premios disponibles. Todas las jugadas tienen premios. Para poder hacerse beneficiario del premio el usuario debe de manera excluyente ingresar una dirección de correo electrónica válida, donde recibirá el código de su premio. Los premios deberán ser canjeados en el plazo de 4 días desde la generación del correo electrónico con el qr que le ha llegado y el dni del usuario. De lo contrario el beneficio quedará disponible para otro ganador.
                                ...
                                <li className='my-2'>
                                    Promoción válida solo para clientes nuevos. Si el beneficiario registra la participación en alguna edición anterior de raspá y ganá o en el girá y ganá, no podrá hacer efectivo su premio.
                            ...
                            <ol className='mx-[1rem] sm:mx-[2rem] text-base sm:text-xl'>
                                ...
                                <li className='my-2'>
                                    <span className='font-bold'>4. 1 TICKET DE $5.000:</span> SSe limitará el canje a 1 ticket válido por el día del canje. No transferible.  Ticket jugable no cobrable, disponible en las máquinas slots habilitadas para tal fin.
                                </li>
                                <li className='my-2'>
                            ...
                            <div className='my-8 flex justify-center'>
                                <img src={logo} className='w-[8rem] sm:w-[12rem]' alt="" />
                            </div>
                        </div>
                    </div>
