            ...
            >
                <div className="flex-grow flex flex-col justify-center py-24 textGothamMedium">
                    ...
                    <div className='flex justify-center items-center'>
                        <button onClick={() => window.open('https://maps.app.goo.gl/rZbQHXaF3aVUEjk86')} className='text-white shadow-lg uppercase mt-8 bg-gradient-to-r from-greenDark to-greenMain border-0 py-2 mx-[4rem]  hover:bg-yellow-600 rounded-3xl items-center text-lg px-8 sm:px-12 sm:text-2xl'>
                            Cómo llegar
                        </button>
                    </div>
                    <div className='flex justify-center items-center content-center mt-48 lg:mt-[8rem]'>
                        <img src={logo} alt="Logo Pilar" className='animate-spin-once-logo w-[8rem] sm:w-[12rem] lg:w-[12rem] xl:w-[12rem]' />
                    </div>
                </div>
