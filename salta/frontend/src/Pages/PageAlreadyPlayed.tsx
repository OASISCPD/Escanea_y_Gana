...
export function PageAlreadyPlayed() {
    //VARIABLE QUE CAMBIAN PARA MOSTRAR LAS IMAGENES Y EL TEMPLATE EN CUESTION
                ...
                >
                    <div className="flex-grow flex flex-col justify-center py-24 textGothamMedium">
                        ...
                        <div className='flex justify-center  items-center'>
                            <button onClick={() => window.open('https://newgaming.com.ar/')} className='text-white shadow-lg uppercase  bg-gradient-to-r hover:scale-95 duration-300 from-redMain to-roseMain border-0 py-2 mx-[4rem] sm:mx-[4rem]  hover:bg-yellow-600 rounded-3xl items-center text-lg px-8 sm:px-12 sm:text-2xl lg:text-lg xl:text-xl'>
                                Entrar a nuevo casino alberdi
                            </button>
                        </div>
                        <div className='flex justify-center items-center content-center mt-[8rem] lg:mt-[8rem]'>
                            <img src={logo} alt="Logo Pilar" className='w-[8rem] sm:w-[12rem]' />
                        </div>
                    </div>
