...
export function TemplateMailMobile() {
    ...
    return (
        <div ref={firstDivRegex} className="pt-12 sm:mx-[2rem] textGothamMedium">
            ...
            <h1 className="text-2xl text-white text-center sm:text-4xl">INGRESÁ UNA DIRECCIÓN DE CORREO VÁLIDA <br />
            ...
            <div className="mt-16 flex justify-center">
                <img src={logo} className="w-[16rem] sm:w-[24rem]" alt="logo empresarial" />
            </div>
