...
export function TemplateMailDesktop() {
    ...
    const firstDivRegex = useRef<HTMLDivElement>(null)//referencia al div
    ...
    useEffect(() => {
        ...
        setTimeout(() => {
            ...
            firstDivRegex.current?.scrollIntoView({ behavior: 'smooth' })//hace scroll
        }, 500);
    }, [])
    ...
    return (
        <div ref={firstDivRegex} className="pt-12 lg:pt-4 sm:mx-[2rem] lg:mx-[12rem] textGothamMedium">
            ...
            <div className="mt-16 lg:my-8 flex justify-center 2xl:my-[4rem]">
                <img src={logo} className="w-[16rem] sm:w-[24rem] lg:w-[16rem] 2xl:w-[20rem]" alt="logo empresarial" />
            </div>
