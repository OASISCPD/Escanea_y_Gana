...
export function Footer({ /* whatsapp, */ instagram, facebook }: PropsLinks) {
    ...
    return (
        <div className="w-full textGothamBook font-semibold">
            <div className="custom-gradient  flex flex-col lg:flex-row lg:justify-between lg:px-[5rem] justify-center items-center py-8">
                <img src={logoLoteria} className="w-[8rem] sm:w-[16rem] lg:w-[12rem] p-2 " alt="Logo Loteria" />
                <h1 className=" text-base sm:text-xl text-gray-300 mx-8 text-center">
